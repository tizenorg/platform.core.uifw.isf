...
static const struct serveable whitelist[] = {
    ...
    { "/chlist_pressed.png", "image/png" },
    { "/channel.png", "image/png" },
    { "/channel_up.png", "image/png" },
    { "/channel_up_pressed.png", "image/png" },
    { "/channel_down.png", "image/png" },
    { "/channel_down_pressed.png", "image/png" },
    { "/back.png", "image/png" },
    { "/back_pressed.png", "image/png" },
    { "/apps.png", "image/png" },
    { "/apps_pressed.png", "image/png" },
    { "/shortcut_icon.png", "image/png" },
    { "/chlist.png", "image/png" },
    { "/exit_pressed.png", "image/png" },
    { "/exit.png", "image/png" },
    { "/info_pressed.png", "image/png" },
    { "/info.png", "image/png" },
    { "/menu_pressed.png", "image/png" },
    { "/menu.png", "image/png" },
    { "/modeswitcher_pressed.png", "image/png" },
    { "/modeswitcher_to_mouse.png", "image/png" },
    { "/modeswitcher_to_tv.png", "image/png" },
    { "/modeswitcher.png", "image/png" },
    { "/mouse_panel_bg.png", "image/png" },
    { "/mute_pressed.png", "image/png" },
    { "/mute.png", "image/png" },
    { "/power_pressed.png", "image/png" },
    { "/power.png", "image/png" },
    { "/remote_keyboard_logo.png", "image/png" },
    { "/remotekeyboard_bg.png", "image/png" },
    { "/remotekeyboard_remocon_bg.png", "image/png" },
    { "/remotekeyboard_remocon_bg3.png", "image/png" },
    { "/return_pressed.png", "image/png" },
    { "/return.png", "image/png" },
    { "/scrollbar.png", "image/png" },
    { "/source_pressed.png", "image/png" },
    { "/source.png", "image/png" },
    { "/volume_down_pressed.png", "image/png" },
    { "/volume_down.png", "image/png" },
    { "/volume_up_pressed.png", "image/png" },
    { "/volume_up.png", "image/png" },
    { "/volume.png", "image/png" },
    { "/air_bt.png", "image/png" },
    { "/air_bt_pressed.png", "image/png" },
    { "/reset_bt.png", "image/png" },
    { "/reset_bt_pressed.png", "image/png" },
    { "/air_panel_bg.png", "image/png" },
    { "/a_bt.png", "image/png" },
    { "/a_bt_pressed.png", "image/png" },
    { "/b_bt.png", "image/png" },
    { "/b_bt_pressed.png", "image/png" },
    { "/c_bt.png", "image/png" },
        ...
        void *user, void *in, size_t len)
{
    ...
    case LWS_CALLBACK_HTTP:
        ...
        if (in && !strcmp((const char *)in, "/leaf.jpg")) {
        ...
        for (i = 0; i < (sizeof(whitelist) / sizeof(whitelist[0]) - 1); i++)
            if (in && strcmp((const char *)in, whitelist[i].urlpath) == 0)
                break;
...
static int 
callback_keyboard(struct lws *wsi,
    enum lws_callback_reasons reason,
    void *user, void *in, size_t len);
